...
import { Wrench, ArrowRight, Check, Navigation, Clock, FileText, Smartphone, Star } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 group">
            <div className="w-8 h-8 rounded-xl bg-slate-900 dark:bg-white flex items-center justify-center transition-transform group-hover:scale-105 shadow-sm">
              <Wrench className="w-4 h-4 text-white dark:text-slate-900 spring-icon" />
            </div>
      ...
      <footer className="py-12 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-lg bg-slate-900 dark:bg-white flex items-center justify-center shadow-sm">
              <Wrench className="w-3 h-3 text-white dark:text-slate-900" />
            </div>
