...
export default function MarketingLandingPage() {
  ...
  return (
    <div className={`min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 selection:bg-sky-500/30 ${inter.className} overflow-x-hidden`}>
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl border-b border-slate-200/60 dark:border-white/5 transition-all">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-xs font-bold text-slate-600 dark:text-slate-300">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="text-xs font-bold text-slate-700 dark:text-slate-200 hover:text-sky-600 dark:hover:text-sky-400 transition-colors px-3 py-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-zinc-800"
            >
              Sign In
            </Link>
            ...
            <Link href="/signup">
              <Button size="sm" className="bg-sky-600 hover:bg-sky-500 text-white font-bold text-xs rounded-full px-4 shadow-md shadow-sky-500/25 h-9">
                Start Trial
              </Button>
            </Link>
          </div>
      ...
      <section className="relative min-h-[92svh] flex flex-col items-center justify-center pt-24 pb-16 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center z-10 flex flex-col items-center">
          <div className="scroll-reveal mb-6 px-4 py-1.5 rounded-full border border-slate-200/80 dark:border-slate-800 bg-white/70 dark:bg-slate-900/70 backdrop-blur-md text-xs font-bold inline-flex items-center gap-2 luxury-card-hover shadow-xs">
            <span className="flex h-2 w-2 relative">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
              <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500" />
            </span>
            <span className="text-slate-800 dark:text-slate-200">TradeFlow 2.0 • Same-Day Dispatch & Invoicing Engine</span>
          </div>
          ...
          <p className="text-lg sm:text-2xl text-slate-600 dark:text-slate-300 mb-10 max-w-3xl mx-auto scroll-reveal font-normal leading-relaxed">
