...
export function AppShell({ children, organization, user, role }: AppShellProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50/70 dark:bg-zinc-950 text-slate-900 dark:text-zinc-100 transition-colors duration-200">
      ...
      <aside className="hidden md:flex flex-col w-[72px] hover:w-64 border-r border-slate-200/80 dark:border-zinc-800/80 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md min-h-screen p-3 sticky top-0 h-screen shadow-xs z-30 transition-all duration-300 ease-in-out group/sidebar overflow-hidden">
        {/* Brand Header */}
        <div className="flex items-center space-x-3 px-1.5 py-3 mb-3 border-b border-slate-100 dark:border-zinc-800">
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-1.5 py-2 rounded-xl text-sm font-semibold transition-all group ${
                  isActive
                    ? 'bg-blue-50/90 dark:bg-blue-950/40 text-blue-600 dark:text-blue-300 font-bold'
              ...
              >
                <div
                  className={`p-2 rounded-xl flex items-center justify-center shrink-0 transition-transform group-hover:scale-105 ${getNavIconStyle(
                    item.href,
                    isActive
                  )}`}
                >
        ...
        <div className="pt-3 border-t border-slate-100 dark:border-zinc-800">
          <div className="flex items-center justify-between px-1">
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-slate-200 to-slate-300 dark:from-zinc-800 dark:to-zinc-700 text-slate-800 dark:text-zinc-200 font-bold flex items-center justify-center text-xs shrink-0 shadow-2xs">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="hidden md:flex items-center justify-between px-8 py-3 border-b border-slate-200/60 dark:border-zinc-800/60 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-md sticky top-0 z-20">
          <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 dark:text-zinc-400">
            <span className="px-2.5 py-1 rounded-lg bg-blue-50 dark:bg-blue-950/80 text-blue-700 dark:text-blue-300 font-bold border border-blue-100 dark:border-blue-900/40">
              TradeFlow FSM
            </span>
            <span>•</span>
